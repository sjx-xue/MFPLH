...
class Train():
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            valid_result, y_pred, y_test, feature = self.eval(phase='eval')
            print(f'Epochs: {epoch} | Train Loss: {total_loss: .4f} | Valid Result: {valid_result}')

            best_result = valid_result['accuracy']
            if best_result > best_valid_result:
